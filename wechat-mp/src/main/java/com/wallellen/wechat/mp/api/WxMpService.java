...
import com.wallellen.wechat.mp.bean.*;
import com.wallellen.wechat.mp.bean.result.*;
...
public interface WxMpService {
   ...
   * @return
   * @throws  com.wallellen.wechat.common.exception.WxErrorException
   */
   ...
   * </pre>
   * @param mediaType         媒体类型, 请看{@link com.wallellen.wechat.common.api.WxConsts}
   * @param fileType          文件类型，请看{@link com.wallellen.wechat.common.api.WxConsts}
   ...
   * </pre>
   * @param mediaType         媒体类型, 请看{@link com.wallellen.wechat.common.api.WxConsts}
   * @param material          上传的素材, 请看{@link com.wallellen.wechat.mp.bean.WxMpMaterial}
   * @return
   * @throws WxErrorException
   */
   ...
   * 详情请见: http://mp.weixin.qq.com/wiki/14/7e6c03263063f4813141c3e17dd4350a.html
   * </pre>
   * @param news              上传的图文消息, 请看{@link com.wallellen.wechat.mp.bean.WxMpMaterialNews}
   * @return
   * @throws WxErrorException
   */
   ...
   * </pre>
   * @param wxMpMaterialArticleUpdate     用来更新图文素材的bean, 请看{@link com.wallellen.wechat.mp.bean.WxMpMaterialArticleUpdate}
   * @return
   * @throws WxErrorException
   */
   ...
   * 详情请见: http://mp.weixin.qq.com/wiki/12/2108cd7aafff7f388f41f37efa710204.html
   * </pre>
   * @param type        媒体类型, 请看{@link com.wallellen.wechat.common.api.WxConsts}
   * @param offset      从全部素材的该偏移位置开始返回，0表示从第一个素材 返回
   * @param count       返回素材的数量，取值在1到20之间
   * @return
   * @throws WxErrorException
   ...
   * @param news
   * @throws WxErrorException
   * @see #massGroupMessageSend(com.wallellen.wechat.mp.bean.WxMpMassGroupMessage)
   * @see #massOpenIdsMessageSend(com.wallellen.wechat.mp.bean.WxMpMassOpenIdsMessage)
   */
   ...
   * <pre>
   * 分组群发消息
   * 如果发送图文消息，必须先使用 {@link #massNewsUpload(com.wallellen.wechat.mp.bean.WxMpMassNews)} 获得media_id，然后再发送
   * 如果发送视频消息，必须先使用 {@link #massVideoUpload(com.wallellen.wechat.mp.bean.WxMpMassVideo)} 获得media_id，然后再发送
   * 详情请见: http://mp.weixin.qq.com/wiki/index.php?title=高级群发接口
   * </pre>
   * @param message
   * @throws WxErrorException
   ...
   * 可以参考，{@link com.wallellen.wechat.common.util.http.MediaUploadRequestExecutor}的实现方法
   * </pre>
   * @param executor
   * @param uri
   * @param data
   ...
   * @return
   * @deprecated Use com.wallellen.wechat.mp.api.WxMpService.getPrepayId(Map<String, String>) instead
   */
  @Deprecated
   ...
   * @param notifyUrl 通知地址
   * @return
   * @deprecated Use com.wallellen.wechat.mp.api.WxMpService.getJSSDKPayInfo(Map<String, String>) instead
   */
  @Deprecated
